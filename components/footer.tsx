    ...
    <footer className="border-t">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-t mt-8 pt-8 text-center text-muted-foreground">
          <p>
            &copy; {currentYear} Secret Chel Society. All rights reserved. In official partnership with Midnight Studios.This site is an independent entity and is not affiliated with or endorsed by EA Sports.
          </p>
        </div>
      </div>
    </footer>
