      ...
      <div className="mt-8 max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
          ...
          <div className="relative h-80 rounded-lg overflow-hidden">
            ...
            <Image src="/scs-hero.jpg" alt="SCS Players" fill className="object-cover" />
          </div>
        </div>
            ...
            {[
              {
                ...
                image: "/scs-staff-1.jpg",
              },
              {
                name: "Sarah Johnson",
                role: "Deputy Commissioner",
                image: "/scs-staff-2.jpg",
              },
              {
                name: "Mike Williams",
                role: "Player Relations",
                image: "/scs-staff-3.jpg",
              },
              {
                name: "Emily Davis",
                role: "Media Director",
                image: "/scs-staff-4.jpg",
              },
            ].map((staff, index) => (
